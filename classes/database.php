<?php
	...
	class database {
		...
		# ===============================
		public function __construct($hostorcon, $user = null, $password = null, $database = null){
			if($user == null)
				$this->connection = $hostorcon;
			else{
				try{
					$this->connection = new PDO('mysql:host='.$hostorcon.';dbname='.$database, $user, $password);
		...
		public function query($sql, $params = null){
			...
			try{
				...
				//if(!empty($GLOBALS['cur']['user']['type']) && $GLOBALS['cur']['user']['type'] < 3)
